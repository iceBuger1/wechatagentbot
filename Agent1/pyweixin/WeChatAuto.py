...
class AutoReply():
    ...
    @staticmethod
    async def auto_reply_to_friend(dialog_window:WindowSpecification,duration:str,callback:Callable, save_file:bool=False,save_media:bool=False,target_folder:str=None,close_dialog_window:bool=True)->dict:
        '''
                ...
                if runtime_id!=initial_runtime_id: 
                    ...
                    if newMessage.class_name()=='mmui::ChatTextItemView':
                        ...
                        if not is_my_bubble:
                            ...
                            reply_content = await callback(newMessage.window_text())
